...
file_put_contents('log.txt', print_r($_POST, true), FILE_APPEND); // Log das requisições POST
...
if (isset($_POST['+'])) {
    ...
    if (isset($_SESSION['cart'][$itemIdToAdd])) {
        ...
        echo json_encode(['quantidade' => $_SESSION['cart'][$itemIdToAdd]['quantity'],
         'id' => $itemIdToAdd,
        ...
        $_SESSION['cart'][$itemIdToAdd] = ['quantity' => 1]; // Adiciona o item com quantidade 1
        // Retorna a nova quantidade e uma mensagem de sucesso
        echo json_encode(['quantidade' => $_SESSION['cart'][$itemIdToAdd]['quantity'],
         'id' => $itemIdToAdd,
         'total' => number_format($_SESSION['valorFinal'], 2, ',', '.'),
