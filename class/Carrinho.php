...
function displayCarte()
 {
    ...
    <div class="product-info">
        ...
        <div class="product-details">
            <span class="product-name">Nome: ' . htmlspecialchars($nomeProduto) . '</span>
            <span class="product-price">Preço: R$ ' . number_format($valor, 2, ',', '.') . '</span>
            <span class="product-quantity" id="quantity' . htmlspecialchars($itemId) . '">Quantidade: ' . htmlspecialchars($quantity) . '</span>
            <span class="product-total" id="totalItem' . htmlspecialchars($itemId) . '">Total: R$ ' . number_format($total, 2, ',', '.') . '</span>
        </div>
...
/*
            echo '<div  id=item' . htmlspecialchars( $itemId ) . ">
            <div class='product-info'>
           
                            <div>
                            <img src='" . htmlspecialchars( $imagePath ) . "' alt='Produto'>
                            <span>Nome:" . htmlspecialchars( $nomeProduto ) . "</span>
                            </div>
                            <div>
                            <span>Preço:" . number_format( $valor, 2 ) . "</span>
                            </div>
                            <span id='quantity" . htmlspecialchars( $itemId ) . "'>Quantidade:" . htmlspecialchars( $quantity ) . "</span>
                            ...
                            <span id='totalItem" . htmlspecialchars( $itemId ) . "'>" . number_format( $total, 2, ',', '.' ) . "</span>
                             <form method='POST' style='display:inline;' class='adicionarRemover' action='Carrinho.php'>
                            <input type='hidden' name='remove' value='" . htmlspecialchars( $itemId ) . "'>
                            <input  class='remove-btn' type='submit' value='Remover'>
                            </form>
